...
''' Each view function takes at least one parameter, called request by convention
	his is an object that contains information about the current web request that has triggered this view, 
	and is an instance of the class django.http.HttpRequest.
'''

'''
	Note: a view is just a Python function that takes an HttpRequest as its first parameter 
